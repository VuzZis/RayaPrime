...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MR_TOMATO = BLOCKS.register("mrtomato", () -> new Block(Properties.create(Material.BAMBOO).hardnessAndResistance(2f).notSolid().doesNotBlockMovement()));
    public static final RegistryObject<Block> MR_TOMATO_GOLD = BLOCKS.register("mrtomato_gold", () -> new Block(Properties.create(Material.BAMBOO).hardnessAndResistance(2f).notSolid().doesNotBlockMovement()));
    ...
    public static final RegistryObject<Block> PLUSH_VUZZ = BLOCKS.register("plush_vuzz", () -> new RotateableBlock(Properties.create(Material.BAMBOO).hardnessAndResistance(2f).notSolid().doesNotBlockMovement()));
    public static final RegistryObject<Block> PLUSH_BLACK = BLOCKS.register("plush_black", () -> new RotateableBlock(Properties.create(Material.BAMBOO).hardnessAndResistance(2f).notSolid().doesNotBlockMovement()));
    public static final RegistryObject<Block> PLUSH_TIMA = BLOCKS.register("plush_tima", () -> new RotateableBlock(Properties.create(Material.BAMBOO).hardnessAndResistance(2f).notSolid().doesNotBlockMovement()));
    public static final RegistryObject<Block> PLUSH_HUNTER = BLOCKS.register("plush_hunter", () -> new RotateableBlock(Properties.create(Material.BAMBOO).hardnessAndResistance(2f).notSolid().doesNotBlockMovement()));
    public static final RegistryObject<Block> PLUSH_LADDEP = BLOCKS.register("plush_laddep", () -> new RotateableBlock(Properties.create(Material.BAMBOO).hardnessAndResistance(2f).notSolid().doesNotBlockMovement()));
