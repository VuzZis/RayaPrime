...
public class RayaPrimeModel<T extends RayaPrimeEntity> extends EntityModel<T> {
	...
	public RayaPrimeModel() {
		...
		MainBody.setTextureOffset(0, 0).addBox(-5.0F, -3.2929F, -4.7221F, 10.0F, 10.0F, 11.0F, 0.0F, false);
		MainBody.setTextureOffset(44, 7).addBox(-6.0F, 6.7071F, -6.9221F, 12.0F, 1.0F, 13.0F, 0.0F, false);
		MainBody.setTextureOffset(39, 0).addBox(-2.0F, 7.7071F, -5.9221F, 4.0F, 1.0F, 5.0F, 0.0F, false);
		MainBody.setTextureOffset(98, 1).addBox(-6.0F, -3.2929F, -6.9221F, 1.0F, 10.0F, 13.0F, 0.0F, false);
		MainBody.setTextureOffset(100, 27).addBox(5.0F, -3.2929F, -6.9221F, 1.0F, 10.0F, 13.0F, 0.0F, false);
		MainBody.setTextureOffset(28, 30).addBox(-6.0F, -4.2929F, -6.9221F, 12.0F, 1.0F, 13.0F, 0.0F, false);
		...
		setRotationAngle(LeftEar, -0.6109F, 0.1745F, 0.2618F);
		LeftEar.setTextureOffset(6, 27).addBox(-1.0F, -6.3F, 0.05F, 4.0F, 6.0F, 2.0F, 0.0F, false);
		LeftEar.setTextureOffset(0, 28).addBox(-1.0F, -10.3F, 1.05F, 2.0F, 4.0F, 1.0F, 0.0F, false);

		RightEar = new ModelRenderer(this);
		RightEar.setRotationPoint(-3.0F, -4.2929F, -2.9221F);
		MainBody.addChild(RightEar);
		setRotationAngle(RightEar, -0.6109F, -0.1745F, -0.2618F);
		RightEar.setTextureOffset(6, 37).addBox(-3.0F, -6.0F, 0.0F, 4.0F, 6.0F, 2.0F, 0.0F, false);
		RightEar.setTextureOffset(0, 36).addBox(-1.0F, -10.0F, 1.0F, 2.0F, 4.0F, 1.0F, 0.0F, false);
		...
		BottomJet.setRotationPoint(0.0F, 8.6071F, -0.9221F);
		MainBody.addChild(BottomJet);
		setRotationAngle(BottomJet, 0.5672F, 0.0F, 0.0F);
		...
		AttentionFace.setTextureOffset(40, 108).addBox(-4.0F, -5.85F, 3.999F, 10.0F, 10.0F, 0.0F, 0.0F, false);
		...
		AngryFace.setTextureOffset(1, 7).addBox(-0.9F, 0.7F, 3.999F, 2.0F, 1.0F, 0.0F, 0.0F, false);
		...
		BottomWingR.setRotationPoint(0.1F, -1.0F, 0.0F);
		...
		UpperWingR.setRotationPoint(0.5F, -0.5F, 0.0F);
		RightWing.addChild(UpperWingR);
		setRotationAngle(UpperWingR, 0.3491F, 0.0F, 0.0F);
		UpperWingR.setTextureOffset(2, 57).addBox(-2.0F, -2.5F, -1.0F, 2.0F, 3.0F, 8.0F, 0.0F, false);
		UpperWingR.setTextureOffset(24, 63).addBox(-2.0F, -2.0F, 7.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
		...
		BottomWingL.setRotationPoint(-0.1F, -1.0F, 0.0F);
		...
		UpperWingL.setRotationPoint(-0.5F, 0.0F, 0.0F);
		LeftWing.addChild(UpperWingL);
		setRotationAngle(UpperWingL, 0.3491F, 0.0F, 0.0F);
		UpperWingL.setTextureOffset(40, 57).addBox(0.0F, -3.0F, -1.0F, 2.0F, 3.0F, 8.0F, 0.0F, false);
		UpperWingL.setTextureOffset(62, 63).addBox(0.0F, -2.5F, 7.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);

		SadFace2 = new ModelRenderer(this);
		SadFace2.setRotationPoint(0.0F, 16.0F, -10.0F);
		SadFace2.setTextureOffset(45, 76).addBox(-5.4F, -4.75F, 3.999F, 10.0F, 10.0F, 0.0F, 0.0F, false);

		eyebrow3_r1 = new ModelRenderer(this);
		eyebrow3_r1.setRotationPoint(0.0F, -1.6987F, 3.998F);
		SadFace2.addChild(eyebrow3_r1);
		setRotationAngle(eyebrow3_r1, 3.1416F, 0.0F, -2.8362F);
		eyebrow3_r1.setTextureOffset(122, 96).addBox(-3.8878F, -0.3F, 0.0F, 3.0F, 1.0F, 0.0F, 0.0F, false);
		eyebrow3_r1.setTextureOffset(122, 96).addBox(-5.2878F, -1.3F, 0.0F, 3.0F, 2.0F, 0.0F, 0.0F, false);

		eyebrow3_r2 = new ModelRenderer(this);
		eyebrow3_r2.setRotationPoint(-2.4F, -2.1F, 3.998F);
		SadFace2.addChild(eyebrow3_r2);
		setRotationAngle(eyebrow3_r2, 0.0F, 0.0F, -0.2182F);
		eyebrow3_r2.setTextureOffset(122, 96).addBox(-1.3F, 0.8F, 0.0F, 3.0F, 1.0F, 0.0F, 0.0F, false);
		eyebrow3_r2.setTextureOffset(122, 96).addBox(-2.7F, 0.8F, 0.0F, 3.0F, 1.0F, 0.0F, 0.0F, false);

		StruggleFace = new ModelRenderer(this);
		StruggleFace.setRotationPoint(0.5F, 16.0F, -10.0F);
		StruggleFace.setTextureOffset(107, 103).addBox(-5.0F, -5.0F, 3.999F, 10.0F, 10.0F, 0.0F, 0.0F, false);

		eyebrow3_r3 = new ModelRenderer(this);
		eyebrow3_r3.setRotationPoint(0.0F, -1.6987F, 3.998F);
		StruggleFace.addChild(eyebrow3_r3);
		setRotationAngle(eyebrow3_r3, -3.1416F, 0.0F, 3.1416F);
		eyebrow3_r3.setTextureOffset(121, 95).addBox(2.5122F, 0.7F, 0.0F, 2.0F, 2.0F, 0.0F, 0.0F, false);
		eyebrow3_r3.setTextureOffset(121, 95).addBox(-2.4878F, 0.7F, 0.0F, 2.0F, 2.0F, 0.0F, 0.0F, false);
	}
	...
	public void setRotationAngles(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		if(curAnim == 0) 
		{
			...
			setRotationAngle(LeftWing, (float) (0.26f+(-0.349f+Math.sin(ageInTicks/5)/24)), (float) (0.349f+Math.sin(ageInTicks/5)/6), 0f);
	...
	public void render(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		...
		ModelRenderer[] faces = new ModelRenderer[] {
			DefFace,
			UwUFace,
			ErrorFace,
			DoneFace,
		...
		switch(ticks % 100) {
			...
			case 25: case 26: case 27: case 28: case 29: case 30:
				matrixStack.translate(0.01f, 0, 0);
			break;
