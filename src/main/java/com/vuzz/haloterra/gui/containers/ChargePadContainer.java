...
public class ChargePadContainer extends Container {
    ...
    public ChargePadContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player,PlauntEntity plaunt) {
        super(ModContainers.CHARGE_PAD_CONTAINER.get(), windowId);
        this.plauntEntity = world.getClosestEntity(PlauntEntity.class, null, player, pos.getX(), pos.getY(), pos.getZ(), AxisAlignedBB.fromVector(new Vector3d(1,1,1)));
        this.playerEntity = player;
        this.playerInventory = new InvWrapper(playerInventory);
        layoutPlayerInventorySlots(8, 72);

        System.out.println(pos.toString());
        if(plaunt != null) {
            plaunt.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
                addSlot(new SlotItemHandler(h, 0, 25, 28));
                addSlot(new SlotItemHandler(h, 1, 26, 46));
                addSlot(new SlotItemHandler(h, 2, 62, 28));
                addSlot(new SlotItemHandler(h, 3, 63, 46));
                addSlot(new SlotItemHandler(h, 4, 98, 28));
                addSlot(new SlotItemHandler(h, 5, 99, 46));
                addSlot(new SlotItemHandler(h, 6, 134, 28));
                addSlot(new SlotItemHandler(h, 7, 135, 46));
            });
        }
    }
