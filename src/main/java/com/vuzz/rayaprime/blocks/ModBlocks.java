...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MR_TOMATO = BLOCKS.register("mrtomato", () -> new Block(Properties.create(Material.BAMBOO).hardnessAndResistance(2f)));
    public static final RegistryObject<Block> MR_TOMATO_GOLD = BLOCKS.register("mrtomato_gold", () -> new Block(Properties.create(Material.BAMBOO).hardnessAndResistance(2f)));
